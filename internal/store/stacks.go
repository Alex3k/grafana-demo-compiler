...
INSERT OR IGNORE INTO session_stacks
 ...
 SELECT id, session_id, region, stack_name, stack_slug, stack_url, otlp_endpoint, instance_id, 'ready', '[]', created_at, updated_at
 FROM deployments WHERE stack_url <> '' AND stack_slug <> ''
